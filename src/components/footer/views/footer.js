        ...
        <ul className="about">
          <li className="about-item file-id">
            <Typography className="mono" type="body2">
              <SplitToSpans className="split-dense">你好，朋友！</SplitToSpans>
            </Typography>
          </li>
          <li className="about-item about-author">
            <Typography className="mono" type="caption">
              ...
              &nbsp;by <a href={socialInfo.github} target="_blank" className="info-link">codeWolf</a>.
            </Typography>
          </li>
          <li className="about-item view-source">
            <Button color="primary" raised target="_blank" href="https://github.com/wanglijuncode/">
              查看站点源码
            </Button>
          </li>
        </ul>
